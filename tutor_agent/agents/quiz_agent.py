...
## 선택지·정답 표기 규칙 (채점 정확도 — 반드시 준수)

- **options의 각 선택지에 "A.", "B.", "1.", "①", "가." 같은 번호·접두어를 붙이지 마세요.**
  순수 선택지 문장만 넣으세요. (화면에서 A/B/C/D 라벨은 자동으로 붙습니다.)
- **answer는 options 중 하나와 글자까지 정확히 동일**해야 합니다.
  띄어쓰기·문장부호·한자까지 그대로 복사하세요. (완전일치로 채점하므로 한 글자라도 다르면 오답 처리됩니다.)
""" + TRANSFER_SUFFIX
